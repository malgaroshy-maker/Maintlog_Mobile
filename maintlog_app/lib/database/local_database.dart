...
class LocalDatabase {
  ...
  Future _createDB(Database db, int version) async {
    ...
    final initialParts = [
      ...
      {
        'id': 'p2',
        'name': 'Cooling Fan 24V',
        'part_number': 'CF-24',
        'stock': 4,
      },
      {
        'id': 'p3',
        'name': 'Conveyor Belt Type C',
        'part_number': 'CB-C-500',
        'stock': 1,
      },
      {
        'id': 'p4',
    ...
    final initialMachines = [
      {'id': 'm1', 'name': 'Filler 1'},
      {'id': 'm2', 'name': 'Filler 2'},
      {'id': 'm3', 'name': 'CFA'},
      {'id': 'm4', 'name': 'Packer A'},
      {'id': 'm5', 'name': 'Palletizer'},
    ];
    for (var m in initialMachines) {
      await db.insert(
        'machines',
        m,
        conflictAlgorithm: ConflictAlgorithm.replace,
    ...
    final initialEngineers = [
      {'id': 'e1', 'full_name': 'John Doe', 'role': 'Lead'},
      {'id': 'e2', 'full_name': 'Mike Smith', 'role': 'Senior'},
      {'id': 'e3', 'full_name': 'Sarah Connor', 'role': 'Junior'},
      {'id': 'e4', 'full_name': 'Ahmed T.', 'role': 'Junior'},
    ];
    for (var e in initialEngineers) {
      await db.insert(
        'engineers',
        e,
        conflictAlgorithm: ConflictAlgorithm.replace,
